...
<main id="content" pw-prepend>
	...
	<section class="acad_clndr">
			<a class="document-link" target="_blank" rel="noreferrer" href="<?= $config->urls->templates ?>assets/docs/WVSU-Calendar-for-AY-2026-2027.pdf">
			...
			<span class="document-link__text">View the 2026-2027 University Academic Calendar</span>
		</a>
	</section>
