...
<main id="content" pw-before>
	...
	<section class="acad_clndr">
			...
			<a class="acad_clndr__link" href="<?= $config->urls->templates ?>assets/docs/WVSU-Calendar-for-AY-2025-2026.pdf"
					>View the West Visayas State University Academic Calendar for 2025-2026</a
			>
	</section>
